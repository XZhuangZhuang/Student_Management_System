...
/*=======================================教师管理模块========================================*/
//添加新的教师信息
void Interface::creatTeacher() {
	int id;//教师编号
	string name;   //教师姓名
	string number, password;     //账号和密码
	int flag = 0;
	while (!flag)
	{
		cout << "请输入新的教师编号：";
	...
	cout << "请输入新的教师的登陆密码：";
	cin >> password;
	teacher teacher1(id,name,number,password);
...
void Interface::Delete_Teacher()
{
	...
	if (flag)
	{
		cout << "没有找到相关的教师信息，请核对相关信息是否有误！" << endl;
		system("pause");
		return;
	}
}
...
/*=======================================管理员管理模块========================================*/
//添加新的管理员信息
void Interface::creatAdministor() {
	int id;//管理员编号
	string name;   //管理员姓名
	string number, password;     //账号和密码
	int flag = 0;
	...
	cout << "请输入新的管理员的登陆密码：";
	cin >> password;
	administor administor1(id, name, number, password);
...
//删除管理员信息
void Interface::Delete_Administor()
{
	int id;
	string name;
	int flag = 1;
	...
	if (flag)
	{
		cout << "没有找到相关的管理员信息，请核对相关信息是否有误！" << endl;
		system("pause");
		return;
	}
}
